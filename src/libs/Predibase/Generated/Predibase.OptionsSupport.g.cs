...
namespace Predibase
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Predibase.AutoSDKRetryOptions Retry { get; set; } = new global::Predibase.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Predibase.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Predibase.IAutoSDKHook>();
        ...
        public global::Predibase.AutoSDKClientOptions AddHook(
            global::Predibase.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Predibase.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Predibase.AutoSDKClientOptions UseAuthorizationProvider(
            global::Predibase.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Predibase.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Predibase.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Predibase.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Predibase.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Predibase.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Predibase.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Predibase.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Predibase.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Predibase.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Predibase.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Predibase.AutoSDKRetryOptions? Retry { get; set; }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Predibase.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Predibase.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Predibase.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Predibase.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Predibase.AutoSDKClientOptions clientOptions,
            global::Predibase.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Predibase.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Predibase.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Predibase.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Predibase.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Predibase.IAutoSDKHook, global::Predibase.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Predibase.AutoSDKHookContext context)
        {
