...
namespace Predibase
{
    public partial class InferenceClient
    {
        ...
        {
            var __response = await CompletionAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Predibase.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Predibase.AutoSDKHttpResponse<global::Predibase.CompletionResponse>> CompletionAsResponseAsync(
            string deploymentName,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Predibase.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Predibase.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CompletionAsync",
                                pathTemplate: "$\"/deployments/{deploymentName}/completions\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::Predibase.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Predibase.CompletionResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Predibase.AutoSDKHttpResponse<global::Predibase.CompletionResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Predibase.CompletionResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
